...
consulta_REAL_con_Duplicados(RESULTADO,PRODUCTO,LINEA,PARTE_CUERPO,OBJETIVO,ESTADO_PARTE_CUERPO,MOMENTO_APLICAR,GENERO,PRECIOMAXIMO):-
    findall(PRODUCTO,producto(PRODUCTO,LINEA,PARTE_CUERPO,OBJETIVO,ESTADO_PARTE_CUERPO,MOMENTO_APLICAR,GENERO,PRECIOMAXIMO),RESULTADO).
consulta_REAL_sin_Duplicados(RESULTADO,PRODUCTO,LINEA,PARTE_CUERPO,OBJETIVO,ESTADO_PARTE_CUERPO,MOMENTO_APLICAR,GENERO,PRECIOMAXIMO):-
